...
INSERT INTO `c_permissions` VALUES ('scene', '环境构建分系统', ' ', '0', ' ', 1, '环境构建分系统', 'AdjustmentsHorizontalIcon', 1);
INSERT INTO `c_permissions` VALUES ('scene_vms_instances', '交换机实例', ' ', 'scene', '/scenario/sceneinstances/all-switches', 1, '交换机实例', 'CubeTransparentIcon', 1);
INSERT INTO `c_permissions` VALUES ('scene_scenario_instances', '场景实例管理', ' ', 'scene', '/scenario/sceneinstances', 1, '场景实例管理', 'CubeTransparentIcon', 1);
INSERT INTO `c_permissions` VALUES ('scene_setting', '场景管理', ' ', 'scene', '/scenario/manage', 1, '场景管理', 'CubeTransparentIcon', 1);
INSERT INTO `c_permissions` VALUES ('ad', '安全实验分系统', ' ', '0', ' ', 1, '安全实验分系统', 'ShieldCheckIcon', 1);
INSERT INTO `c_permissions` VALUES ('ad_test', '攻防演练', ' ', 'ad', '/ad', 1, '攻防演练', 'ShieldCheckIcon', 1);
INSERT INTO `c_permissions` VALUES ('ad_team', '队伍管理', ' ', 'ad', '/ad/team', 1, '队伍管理', 'ShieldCheckIcon', 1);
