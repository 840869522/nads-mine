...
```shelll
## 启动日志收集容器，需要启动最新的elastic-data-collector，假设镜像名为 elastic-data-collector:v1.2 那么命令如下

docker run -it -d -p 9200:9200 -p 5601:5601 -p 3128:3128 elastic-data-collector:v1.2 /bin/bash
# 创建交换机
