...
import {
    ...
    CircularProgress, Alert as MuiAlert, useTheme, Paper, IconButton, Chip, Tooltip,
    TextField, InputAdornment, Switch, FormControlLabel, Menu, MenuItem
} from '@mui/material';
        ...
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="xl" PaperProps={{ sx: { height: '90vh' } }}disableEnforceFocus>
            ...
            <DialogContent dividers>
                ...
                {isLoading ? (
                    ...
                    <Box component={Paper} sx={{ height: 'calc(100% - 60px)', width: '100%' }}>
                        <DataGrid
