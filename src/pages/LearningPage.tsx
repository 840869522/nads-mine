...
//       const errorMessage = e instanceof Error ? `未能从AI获取评估。错误: ${e.message}` : "未能从AI获取评估。";
...
//
//       {currentQuestion && (
//         <Card title={`问题 ${currentQuestionIndex + 1} / ${questions.length}`}>
//           <QuestionDisplay
...
//
//           {evaluationResults[currentQuestion.id] && !isLoading && (
//             <div className="mt-4">
//               <QuizResultDisplay result={evaluationResults[currentQuestion.id]!} />
//             </div>
//           )}
//            {evaluationResults[currentQuestion.id] === null && !isLoading && (
//              <Alert type="warning" message="无法获取AI评估。您仍然可以继续。" className="mt-4" />
//            )}
//
...
//             </span>
//             <Button onClick={handleNextQuestion} disabled={!userAnswers[currentQuestion.id] || isLoading} variant="primary">
//               {currentQuestionIndex === questions.length - 1 ? "完成测验" : "下一个问题"}
//             </Button>
//           </div>
//         </Card>
//       )}
